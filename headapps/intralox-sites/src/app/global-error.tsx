...
/** global-error runs outside normal RSC i18n; empty messages avoid manifest/RSC issues. */
const globalErrorMessages = {} as AbstractIntlMessages;
  ...
  if (page) {
    return (
      <Providers
        ...
        locale={scConfig.defaultLanguage ?? 'en'}
      >
        <Layout page={page} />
      </Providers>
    );
