/**
 * Fork of @sitecore-content-sdk/nextjs Link (CJS) for Next.js App Router.
 * Upstream passes `locale: false` to next/link, which React 19 forwards to the DOM as invalid.
 */
/* eslint-disable @typescript-eslint/no-require-imports -- CJS fork; require() is intentional */
"use strict";
'use client';
...
exports.Link = (0, react_1.forwardRef)((props, ref) => {
    ...
    if (href && !isEditing) {
        ...
        if (isMatching && !isFileUrl) {
            return (react_1.default.createElement(link_1.default, Object.assign({ href: { pathname: href, query: querystring, hash: anchor }, key: "link", title: value.title, target: value.target, className: value.class }, rest, { ref: ref }, (process.env.TEST
                ? {
